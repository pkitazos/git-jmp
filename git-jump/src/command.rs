...
// --- both of these two are probably not needed / auto-generated by clap

pub fn version_sub_command() -> Result<Msg> {
    let version = env!("CARGO_PKG_VERSION").to_string();
    Ok(Msg::Info(vec![version]))
}

/// side-effect: read the help text
pub fn help_sub_command() -> Result<Msg> {
    let help_text = include_str!("../../docs/help.txt").to_string();
    // need to also format this probably?
    Ok(Msg::Info(vec![help_text]))
}
